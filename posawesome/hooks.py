...
after_migrate = [
    ...
    "posawesome.patches.add_payment_transaction_references.execute",
]
        ...
        "filters": [
            [
                ...
                (
                    ...
                    "Sales Invoice-custom_transaction_reference",
                    "POS Invoice-custom_transaction_reference",
                    "Sales Invoice-posa_payment_transaction_references",
                    "POS Invoice-posa_payment_transaction_references",
                    ...
                    "User-posa_pos_pin",
                    "Sales Invoice-custom_tax",
                    "Sales Invoice-custom_cu_status",
                    "Sales Invoice-custom_cu_invoice_number",
                    "Sales Invoice-custom_cu_serial_number_",
                    "Sales Invoice-custom_cu_timestamp",
                    "Sales Invoice-custom_trader_system_invoice_number",
                    "Sales Invoice-custom_tims_verification_url",
                    "Sales Invoice-custom_cu_qr_payload_raw",
                    "Sales Invoice-custom_cu_qr_image",
                    "Sales Invoice-custom_column_break_y4d3g",
                    "Sales Invoice-custom_fiscalization_attempts",
                    "Sales Invoice-custom_last_fiscalization_attempts",
                    "Sales Invoice-custom_cu_error_message",
                    "Sales Invoice-custom_close_receipt_raw_response",
                    "POS Invoice-custom_tims",
                    "POS Invoice-custom_kra__tims_fiscalization",
                    "POS Invoice-custom_cu_status",
                    "POS Invoice-custom_cu_invoice_number",
                    "POS Invoice-custom_cu_serial_number",
                    "POS Invoice-custom_cu_timestamp",
                    "POS Invoice-custom_trader_system_invoice_number",
                    "POS Invoice-custom_tims_verification_url",
                    "POS Invoice-custom_cu_qr_payload_raw",
                    "POS Invoice-custom_column_break_gvoqi",
                    "POS Invoice-custom_fiscalization_attempts",
                    "POS Invoice-custom_last_fiscalization_attempt",
                    "POS Invoice-custom_fiscalization_lock",
                    "POS Invoice-custom_cu_error_message",
                    "POS Invoice-custom_close_receipt_raw_response",
                    "POS Invoice-custom_customer_details",
                    "POS Invoice-custom_receipt_customer_name",
                    "POS Invoice-custom_receipt_phone_number",
                    "POS Invoice-custom_customer_transaction_details",
                    "POS Invoice-custom_payment_validation_status",
                    "POS Invoice-custom_validated_amount",
                    "POS Invoice-custom_payment_payer_name",
                    "POS Invoice-custom_payment_phone_number",
                    "POS Invoice-custom_payment_validation_message",
                    "POS Invoice-custom_payment_validated_at",
                    "POS Invoice Item-custom_tims",
                    "POS Invoice Item-custom_tims_item_details",
                    "POS Invoice Item-custom_vat_class",
                    "POS Invoice Item-custom_tims_tax_code",
                    "POS Invoice Item-custom_tims_item_code",
                    "POS Invoice Item-custom_fiscalized_quantity",
                    "POS Invoice Item-custom_fiscalized_amount",
                    "POS Invoice Item-custom_walkin_customer_details",
                    "POS Invoice Item-custom_receipt_details",
                    "POS Invoice Item-custom_receipt_customer_name",
                    "POS Invoice Item-custom_transaction_reference",
                    "POS Invoice Item-custom_payment_validation",
                    "POS Invoice Item-custom_payment_validation_status",
                    "POS Invoice Item-custom_validated_amount",
                    "POS Invoice Item-custom_payment_payer_name",
                    "POS Invoice Item-custom_payment_phone_number",
                    "POS Invoice Item-custom_payment_validation_message",
                    "POS Invoice Item-custom_paymeent_validated_at",
    ...
    },
    {
        ...
        "filters": [
            [
                "name",
                "in",
                ("POS Receipt - TIMS Fiscalized", "Sales Invoice - TIMS Fiscalized"),
            ]
        ],
    },
    {
